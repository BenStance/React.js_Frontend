...
import '../assets/styles/FooterStyles.css'; // Updated CSS file
    ...
    <footer className="custom-footer">
      <Container fluid>
        <Row className="custom-footer-row justify-content-center">
          {/* First Column */}
          <Col md={3} className="custom-footer-col">
            ...
            <div className="custom-footer-icon-text">
              <FaMapMarkerAlt />
              <span>255 Kikuyu-Dodoma, Tanzania</span>
            </div>
            <div className="custom-footer-icon-text">
              <FaEnvelope />
            ...
            <div className="custom-footer-icon-text">
              <FaPhone />
              <span>+255 622 472 600</span>
            </div>
          </Col>

          {/* Second Column */}
          <Col md={3} className="custom-footer-col text-center">
          ...
          <Col md={3} className="custom-footer-col">
            ...
            <Row>
              ...
              <Col xs={6}>
                <ul className="custom-footer-quick-links">
                  ...
                  <li>
                    <a href="#subscription-section"><FaLink /> Subscription</a>
                  </li>
                </ul>
              </Col>
            </Row>
            ...
            <div className="custom-footer-social">
              ...
              <a href={`https://wa.me/${+255622472600}`} target="_blank" rel="noopener noreferrer" className="custom-footer-social-icon">
                <FaWhatsapp />
              </a>
            </div>
          </Col>
