...
const projects = [
  ...
  },
  {
    ...
    description: 'Comprehensive LAN installation for a government building ensuring secure and fast connectivity.',
    technologies: ['Networking', 'Cisco', 'Security','mikrotik','UTP & Fiber'],
    image: require('../assets/images/lan-installation.jpeg'),
  },
  {
    id: 3,
    title: 'Website & Poster Design',
    description: 'Creative and responsive website and poster design for a marketing campaign.',
    technologies: ['JS', 'CSS', 'Photoshop','Frameworks'],
  ...
  },
  {
    ...
    technologies: ['Scripts','Manually','Enumeration','Payloads','Automated Tools'],
    image: require('../assets/images/pict5.jpg'),
  },
  {
  id: 5,
  title: 'Cloud Computing Implementation',
  description: 'Implementing secure and scalable cloud solutions for enterprise clients.',
  ...
  },
  {
    ...
    technologies: ['macOS', 'Linux', 'Hardware Repair', 'Software Troubleshooting'],
